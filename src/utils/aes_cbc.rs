...
mod tests {
    ...
    #[test]
    fn round_trip() {
        let contents = " askl;fjsajf AFA FR89AJF AOIFJ A4TJ 8AFJAJW T348TU 8AEFUA WT8kljaslkjfklsja fiaowejfri awjf aghargiojaioj rgaiojf agjaiorg aiojfija rhioajsdifjiajg aj giawjti jawer".as_bytes();
